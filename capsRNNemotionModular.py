...
from feature_builder import build_rand_feat, get_training_data_conv, get_training_data_time
...
caps2_n_caps = 8 # ouput of capsule layer (num of classes)
caps2_n_dims = 16
...
lstm2 = build_lstm_layers(X, caps1_n_maps, caps1_n_dims)
exit()

# check shape here
#caps1_n_caps = caps1_n_maps * 13 * 5  # 1152 primary capsules
caps1_n_caps = caps1_n_maps * np.prod(conv2.shape.as_list()[1:-1])  # 1152 primary capsules

caps2_output_round_2 = build_capsnet_layers(conv2, caps1_n_caps, caps1_n_dims, X, caps2_n_caps, caps2_n_dims)
