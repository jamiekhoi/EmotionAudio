...
def model_inputs_lstm():
    """
    Create the model inputs for lstm
    """
    image_width = 39
    image_height = 13
...
def build_lstm_layers(X, caps1_n_maps, caps1_n_dims):
    ...
    print(np.prod(conv2.shape.as_list()[1:-1]))
...
def build_capsnet_layers(conv2, caps1_n_caps, caps1_n_dims, X, caps2_n_caps, caps2_n_dims):
    caps1_raw = tf.reshape(conv2, [-1, caps1_n_caps, caps1_n_dims],
                           name="caps1_raw")
    print('caps1_raw shape', caps1_raw.shape)
    caps1_output = squash(caps1_raw, name="caps1_output")
    print('caps1_output', caps1_output.shape)
    #exit()
